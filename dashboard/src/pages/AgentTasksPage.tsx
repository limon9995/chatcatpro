...
export function AgentTasksPage({ th, pageId, onToast, onOpenOrders, onOpenPrint, onOpenFollowUp, onOpenAccounting, onOpenSettings }: {
  ...
  const tasks: TaskCard[] = [
    ...
    },
    {
      ...
      bn: 'Packing করা বাকি',
      en: 'Packing Pending',
      descBn: 'Confirmed order গুলো pack করা বাকি আছে — Orders পেজে Packing Zone দেখুন।',
      descEn: 'Confirmed orders need to be packed — check the Packing Zone in Orders page.',
      color: '#7c3aed',
      orders: orders.filter((o) => o.status === 'CONFIRMED'),
      count: orders.filter((o) => o.status === 'CONFIRMED').length,
      preset: { status: 'CONFIRMED', label: 'Confirmed Orders — Ready to Pack' },
    },
    {
      key: 'courier_booking',
      section: 'Courier',
