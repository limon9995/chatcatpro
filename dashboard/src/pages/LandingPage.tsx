...
:root{
  --bg:#05050d;--surface:#0c0c18;--surface2:#13131f;
  --border:rgba(255,255,255,0.07);--border2:rgba(255,255,255,0.12);
  --text:#f0f0f8;--muted:rgba(240,240,248,0.44);
  --accent:#5b4cf5;--accent2:#8b5cf6;--accent3:#06b6d4;
  --gold:#f59e0b;--green:#10b981;--radius:18px;
}
...
/* ══ Nav ══ */
nav{position:fixed;top:12px;left:50%;transform:translateX(-50%);z-index:100;width:calc(100% - 48px);max-width:1100px;padding:0 20px;height:54px;display:flex;justify-content:space-between;align-items:center;background:rgba(5,5,13,0.72);backdrop-filter:blur(24px);-webkit-backdrop-filter:blur(24px);border:1px solid var(--border2);border-radius:14px;box-shadow:0 4px 24px rgba(0,0,0,0.4),inset 0 1px 0 rgba(255,255,255,0.06)}
...
.hero::before{content:'';position:absolute;inset:0;background:
  radial-gradient(ellipse 80% 60% at 20% 10%,rgba(91,76,245,.22),transparent),
  radial-gradient(ellipse 60% 50% at 80% 20%,rgba(139,92,246,.16),transparent),
  radial-gradient(ellipse 50% 40% at 50% 80%,rgba(6,182,212,.10),transparent);pointer-events:none}
...
.hero h1 .grad{background:linear-gradient(135deg,#818cf8 0%,#c084fc 40%,#fb923c 80%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}
...
<section class="hero">
  ...
  <div class="hero-badge fade-up">
    ...
    Beta চলছে — সীমিত সংখ্যক client নেওয়া হচ্ছে
  </div>

  <h1 class="fade-up delay-1">
    Facebook Commerce<br/><span class="grad">Autopilot এ চলুক</span>
  </h1>
  ...
  <div class="hero-btns fade-up delay-3">
    ...
    <a href="https://www.facebook.com/Chatcatpro" target="_blank" rel="noopener" class="btn-ghost">Free Demo নিন</a>
  </div>
  ...
  <div style="max-width:1100px;margin:0 auto">
    ...
    <div class="testimonials-grid">
      ...
      <div class="tcard">
        ...
        <div class="tcard-text">"আগে রাত ২টা পর্যন্ত manually order নিতাম। এখন bot সব করে, আমি শুধু confirm করি। সত্যিই অবিশ্বাস্য।"</div>
        <div class="tcard-author">
          <div class="tcard-avatar">র</div>
          <div>
            <div class="tcard-name">Rahim Enterprise</div>
      ...
      <div class="tcard">
        <div class="tcard-stars">★★★★★</div>
        <div class="tcard-text">"OCR feature টা আমার business বদলে দিয়েছে। Customer screenshot পাঠালে product automatically detect হয়ে যায়।"</div>
        <div class="tcard-author">
          <div class="tcard-avatar">ক</div>
          <div>
            <div class="tcard-name">Karim Fashion House</div>
      ...
      <div class="tcard">
        <div class="tcard-stars">★★★★★</div>
        <div class="tcard-text">"Courier booking এখন একটু সময়ের ব্যাপার। আগে প্রতিটা courier site আলাদা আলাদা গিয়ে করতাম। এখন সব এখানে।"</div>
        <div class="tcard-author">
          <div class="tcard-avatar">ফ</div>
          <div>
            <div class="tcard-name">Fatema Collection</div>
...
<div class="cta-section" id="contact">
  ...
  <p>Free demo নিন। Live দেখান কীভাবে আপনার business automation হবে।</p>
...
['nav-signup','cta-signup','hero-signup'].forEach(function(id) {
  var el = document.getElementById(id);
