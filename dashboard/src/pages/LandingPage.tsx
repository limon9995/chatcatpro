...
@media(max-width:768px){.demo-sec{padding:72px 5% 56px}.scene-root{height:460px;transform:none!important}.sc-chip{display:none}.phone-body{width:224px}.p-screen{height:400px}}
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:18px;padding:32px 28px">
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Smart Bot — ২৪/৭ customer reply</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Customer message করলে bot product info দেয়, order নেয়</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Order Management — নিজেই note করে</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Order list, status tracking, confirm — সব dashboard এ</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Courier Booking — Pathao, Steadfast, RedX</div><div style="font-size:12px;color:var(--muted);margin-top:2px">এক জায়গা থেকে bulk booking, tracking, status</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Accounting — হিসাব-নিকাশ automatic</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Revenue, expenses, returns, profit — সব auto sync</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Customer CRM — পুরোনো customer track</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Order history, tags, best buyers, analytics</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Analytics — কোন product বেশি বিকাচ্ছে</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Week vs last week growth, best products ranking</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Broadcast — সবাইকে একসাথে message</div><div style="font-size:12px;color:var(--muted);margin-top:2px">নতুন collection launch? একটা click এই সবাই জানবে</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Product Catalog — ছবি দেখলেই price বলবে</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Public catalog page এ সব product — customer নিজেই দেখতে পারবে</div></div>
          </div>
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Memo / Invoice Printing</div><div style="font-size:12px;color:var(--muted);margin-top:2px">প্রতিটি order এর memo/invoice print করুন — custom design সহ</div></div>
          </div>
        </div>
      </div>
