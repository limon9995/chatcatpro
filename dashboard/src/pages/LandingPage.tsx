    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;align-items:start">
      ...
      <div style="background:var(--surface);border:1px solid var(--border);border-radius:18px;padding:32px 28px">
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
          ...
          <div style="display:flex;align-items:flex-start;gap:12px">
            <div style="width:22px;height:22px;border-radius:50%;background:rgba(16,185,129,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px;font-size:12px">✅</div>
            <div><div style="font-weight:700;font-size:14px">Product Catalog + OCR — ছবি দেখলেই price বলবে</div><div style="font-size:12px;color:var(--muted);margin-top:2px">Public catalog page, screenshot থেকে product detect</div></div>
          </div>
        </div>
      </div>
