...
.header-right{display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0}
.memo-qr{background:#fff;border-radius:3px;padding:2px;line-height:0}
.memo-qr img{display:block;width:${c4 ? '28px' : '34px'};height:${c4 ? '28px' : '34px'}}
