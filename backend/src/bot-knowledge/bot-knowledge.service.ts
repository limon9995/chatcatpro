...
export class BotKnowledgeService {
  ...
  private defaultSystemReplies() {
    return this.normalizeSystemReplies({
      ...
      agent_handoff: {
        template:
          '🙏 আপনার তথ্য আমাদের হিউম্যান এজেন্টের কাছে ট্রান্সফার করা হচ্ছে। অনুগ্রহ করে একটু অপেক্ষা করুন{{hotlineBlock}}',
        fallback: '🙏 আপনার তথ্য হিউম্যান এজেন্টের কাছে ট্রান্সফার করা হচ্ছে। অনুগ্রহ করে একটু অপেক্ষা করুন।',
      },
      agent_checkin: {
        template:
          'দুঃখিত অপেক্ষার জন্য! 🙏 আপনি কি ইতিমধ্যে আমাদের agent-এর সাথে কথা বলতে পেরেছেন, নাকি এখনো সাহায্য দরকার?',
        fallback: 'আপনি কি আমাদের agent-এর সাথে কথা বলতে পেরেছেন, নাকি এখনো সাহায্য দরকার?',
      },
      product_not_found: {
...
{{productInfoNote}}`,
      ...
      greeting: {
        template:
          'আস্সালামুআলাইকুম 💖 স্বাগতম!\n\nআমাদের product দেখতে code বা screenshot দিন। অর্ডার করতে চাইলে জানান 😊',
        fallback:
          'আস্সালামুআলাইকুম 💖 স্বাগতম! Product code বা screenshot দিন।',
      },
    });
  }
