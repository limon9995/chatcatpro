...
INSERT INTO "new_Order" ("address", "callResult", "callRetryCount", "callSessionId", "callStatus", "confirmedAt", "createdAt", "customerName", "customerOfferedPrice", "customerPsid", "id", "lastCallAt", "negotiationRequested", "orderNote", "pageIdRef", "phone", "source", "status", "updatedAt") SELECT "address", "callResult", "callRetryCount", "callSessionId", "callStatus", "confirmedAt", "createdAt", "customerName", "customerOfferedPrice", "customerPsid", "id", "lastCallAt", "negotiationRequested", "orderNote", "pageIdRef", "phone", "source", "status", "updatedAt" FROM "Order";
DROP TABLE "Order";
