...
INSERT INTO "new_Page" ("address", "autoMemoDesignModeOn", "automationOn", "banglaCallScript", "banglaVoiceFileUrl", "banglaVoiceId", "businessAddress", "businessName", "businessPhone", "callConfirmModeOn", "callConfirmationScope", "callLanguage", "callMode", "callProvider", "codLabel", "createdAt", "currencySymbol", "deliveryFeeInsideDhaka", "deliveryFeeOutsideDhaka", "deliveryTimeText", "englishCallScript", "englishVoiceFileUrl", "englishVoiceId", "id", "infoModeOn", "isActive", "logoUrl", "maxCallRetries", "memoFooterText", "memoLayout", "memoSaveModeOn", "memoTemplateModeOn", "memoTheme", "memosPerPage", "ocrOn", "orderModeOn", "ownerId", "pageId", "pageName", "pageToken", "phone", "primaryColor", "printModeOn", "productCodePrefix", "retryIntervalMinutes", "ttsProvider", "updatedAt", "verifyToken", "voiceGeneratedAt", "voiceStyle", "voiceType") SELECT "address", "autoMemoDesignModeOn", "automationOn", "banglaCallScript", "banglaVoiceFileUrl", "banglaVoiceId", "businessAddress", "businessName", "businessPhone", "callConfirmModeOn", "callConfirmationScope", "callLanguage", "callMode", "callProvider", "codLabel", "createdAt", "currencySymbol", "deliveryFeeInsideDhaka", "deliveryFeeOutsideDhaka", "deliveryTimeText", "englishCallScript", "englishVoiceFileUrl", "englishVoiceId", "id", "infoModeOn", "isActive", "logoUrl", "maxCallRetries", "memoFooterText", "memoLayout", "memoSaveModeOn", "memoTemplateModeOn", "memoTheme", "memosPerPage", "ocrOn", "orderModeOn", "ownerId", "pageId", "pageName", "pageToken", "phone", "primaryColor", "printModeOn", "productCodePrefix", "retryIntervalMinutes", "ttsProvider", "updatedAt", "verifyToken", "voiceGeneratedAt", "voiceStyle", "voiceType" FROM "Page";
DROP TABLE "Page";
